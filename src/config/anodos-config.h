/* src/config/anodos-config.h.  Generated from anodos-config.h.in by configure.  */
/* src/config/anodos-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ANDS_CONFIG_H

#define ANDS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Anodos Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Anodos Core"
...
#define PACKAGE_BUGREPORT "https://github.com/anodos/anodos/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Anodos Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Anodos Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "anodoscore"
