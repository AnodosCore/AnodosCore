...
const char * const BITCOIN_CONF_FILENAME = "anodos.conf";
const char * const BITCOIN_PID_FILENAME = "anodosd.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "anodos" is a composite category enabling all Anodos-related debug output
            if(ptrCategory->count(string("anodos"))) {
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty anodos.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override anodos.conf
