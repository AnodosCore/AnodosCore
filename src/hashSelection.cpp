...
uint256 scrambleHash(uint256 blockHash) {
	...
	string sixteen2 = hashString.substr(30,46); // extract last 19-34 chars
	string sixteen = hashString.substr(46,62); // extract last 3-18 chars
	string last2 = hashString.substr(62,64); // extract last 2 chars
	for(int i=0; i<16; i++){
