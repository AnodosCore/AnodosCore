    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Anodos Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Anodos Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  anodos-qt [" + tr("command-line options") + "]                     " + "\n";
...
PrivateSend uses an anodostive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
For more info see <a href=\"https://anodos.atlassian.net/wiki/display/DOC/PrivateSend\">https://anodos.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Anodos Core is shutting down...") + "<br /><br />" +
