...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AnodosNetwork") type = AnodosNetwork;
    if(strType == "AnodosNetworkVariable") type = AnodosNetworkVariable;
    ...
    if(strType == "ProjectMileanodos") type = ProjectMileanodos;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AnodosNetwork) s = "AnodosNetwork";
    if(type == AnodosNetworkVariable) s = "AnodosNetworkVariable";
    ...
    if(type == ProjectMileanodos) s = "ProjectMileanodos";
