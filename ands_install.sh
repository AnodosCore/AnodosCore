...
purgeOldInstallation() {
    ...
    sleep 5s
    echo -e "${GREEN}By installing the ${RED}$COIN_NAME ${GREEN}Masternode, you agree to HODL and not panic sell/dump into buy lines.${NC}"
    sleep 5s
    echo -e "${GREEN}On with the install!${NC}"
    sleep 2s
    #kill wallet daemon
