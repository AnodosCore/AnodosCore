...
/* Version of hwloc */
/* #undef HWLOC_HWLOC191_HWLOC_VERSION */
...
/* Location of external hwloc header */
#define MCA_hwloc_external_openfabrics_header "/usr//include/hwloc/openfabrics-verbs.h"

/* Complete set of command line arguments given to ROMIOs configure script */
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=2   -I/usr//include -I/build/openmpi-i_T6n0/openmpi-1.10.2/opal/mca/event/libevent2021/libevent -I/build/openmpi-i_T6n0/openmpi-1.10.2/opal/mca/event/libevent2021/libevent/include' FFLAGS='-g -O2 -fstack-protector-strong' LDFLAGS='-Wl,-Bsymbolic-functions -Wl,-z,relro   -L/usr//lib' --enable-shared --disable-static  --prefix=/usr --disable-aio"
...
#define OMPI_TARBALL_VERSION "1.10.2"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 328449

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 5.3.1
...
#define OPAL_IDENT_STRING "1.10.2"
...
#define OPAL_PACKAGE_STRING "Open MPI buildd@lgw01-57 Distribution"
...
#define OPAL_RELEASE_DATE "Jan 21, 2016"
...
#define OPAL_REPO_REV "v1.10.1-145-g799148f"
...
#define OPAL_TARBALL_VERSION "1.10.2"
...
#define ORTE_RELEASE_DATE "Jan 21, 2016"
...
#define ORTE_REPO_REV "v1.10.1-145-g799148f"

/* Tarball filename version string of Open MPI Run-Time Environment */
#define ORTE_TARBALL_VERSION "1.10.2"
...
#define OSHMEM_RELEASE_DATE "Jan 21, 2016"
...
#define OSHMEM_TARBALL_VERSION "1.10.2"
...
#define PACKAGE_STRING "Open MPI 1.10.2"
...
#define WRAPPER_EXTRA_LIBS "-ldl -libverbs -lutil -lm "
