...
Only requiring some minor changes is anodos.cpp.
...
Changes to anodos.cpp
----------------------
anodos.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
