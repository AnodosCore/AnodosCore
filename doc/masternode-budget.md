...
Format: ```mngovernance prepare proposal-name url payment-count block-start anodos-address monthly-payment-anodos```
...
Format: ```mngovernance submit proposal-name url payment-count block-start anodos-address monthly-payment-anodos fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using anodos.conf setup)
